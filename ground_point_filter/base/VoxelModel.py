...
from ground_point_filter.base.Scan import ScanABC
from ground_point_filter.base.voxel_utils.iterators.VMRawIterator import VMRawIterator
from ground_point_filter.base.voxel_utils.plotters.Voxel_model_plotter import VoxelModelPlotter
from ground_point_filter.base.voxel_utils.separators.FastVMSeparator import FastVMSeparator
...
class VoxelModelABC(ABC):
    ...
    def __init__(self, scan: ScanABC, step, dx, dy, is_2d_vxl_mdl=True):
        self.id = None
...
class VoxelModel(VoxelModelABC):
    ...
    def __init__(self, scan: ScanABC, step, dx=0.0, dy=0.0, is_2d_vxl_mdl=True,
